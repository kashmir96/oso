-- Seed ingredients with known prices from Sunset Glow / Midnight Mousse sheets
...
SELECT 'PP-BABY-BUTTER', 'Baby Butter', id, v.pct FROM ingredients i
JOIN (VALUES
...
-- Serum
INSERT INTO product_ingredients (product_sku, product_name, ingredient_id, percentage)
SELECT 'PP-SERUM', 'Serum', id, v.pct FROM ingredients i
JOIN (VALUES
...
-- Liquid Shampoo
INSERT INTO product_ingredients (product_sku, product_name, ingredient_id, percentage)
SELECT 'PP-SHAMPOO', 'Liquid Shampoo', id, v.pct FROM ingredients i
JOIN (VALUES
  ('Water', 54.95), ('Plantacare 1200', 17.0), ('Stepanol', 8.0), ('Glycerine', 5.0),
  ('Water', 10.0), ('Aloe Vera Powder', 0.05), ('Tallow', 0.1), ('Citric Acid', 0.3),
  ('Spectrastat', 2.0), ('Rose Geranium', 0.2), ('Vitamin E', 0.1), ('Sodium Chloride', 0.3)
) AS v(ing_name, pct) ON i.name = v.ing_name;

-- Body Oil
INSERT INTO product_ingredients (product_sku, product_name, ingredient_id, percentage)
SELECT 'PP-BODY-OIL', 'Body Oil', id, v.pct FROM ingredients i
JOIN (VALUES
...
-- Conditioner
INSERT INTO product_ingredients (product_sku, product_name, ingredient_id, percentage)
SELECT 'PP-CONDITIONER', 'Conditioner', id, v.pct FROM ingredients i
JOIN (VALUES
...
-- Cleanser
INSERT INTO product_ingredients (product_sku, product_name, ingredient_id, percentage)
SELECT 'PP-CLEANSER', 'Cleanser', id, v.pct FROM ingredients i
JOIN (VALUES
  ('Water', 58.45), ('Plantacare 1200', 17.0), ('Stepanol', 8.0), ('Glycerine', 5.0),
  ('Water', 2.0), ('Aloe Vera Powder', 0.05), ('Tallow', 5.0), ('Spectrastat', 2.0),
  ('Rose Geranium', 0.2), ('Citric Acid', 0.3)
) AS v(ing_name, pct) ON i.name = v.ing_name;

-- Liquid Soap
INSERT INTO product_ingredients (product_sku, product_name, ingredient_id, percentage)
SELECT 'PP-LIQUID-SOAP', 'Liquid Soap', id, v.pct FROM ingredients i
JOIN (VALUES
...
-- Liquid Lotion
INSERT INTO product_ingredients (product_sku, product_name, ingredient_id, percentage)
SELECT 'PP-LOTION', 'Liquid Lotion', id, v.pct FROM ingredients i
JOIN (VALUES
...
-- Summer Balm
INSERT INTO product_ingredients (product_sku, product_name, ingredient_id, percentage)
SELECT 'PP-SUMMER-BALM', 'Summer Balm', id, v.pct FROM ingredients i
JOIN (VALUES
  ('Tallow', 35.8), ('Jojoba Oil', 9.0), ('Olive Squalane', 8.73),
  ('Beeswax', 6.27), ('Olive Squalane', 5.0), ('Zinclear', 35.0), ('Rose Geranium', 0.2)
) AS v(ing_name, pct) ON i.name = v.ing_name;

-- Sunset Glow
INSERT INTO product_ingredients (product_sku, product_name, ingredient_id, percentage)
SELECT 'PP-SUNSET-GLOW', 'Sunset Glow', id, v.pct FROM ingredients i
JOIN (VALUES
...
-- Midnight Mousse
INSERT INTO product_ingredients (product_sku, product_name, ingredient_id, percentage)
SELECT 'PP-MIDNIGHT-MOUSSE', 'Midnight Mousse', id, v.pct FROM ingredients i
JOIN (VALUES
  ('Tallow', 95.5), ('Jojoba Oil', 2.0), ('Chocolate Treat', 0.2),
  ('Brazilian Orange Essential Oil', 0.05), ('Manuka Honey', 2.0)
) AS v(ing_name, pct) ON i.name = v.ing_name;

-- Natural (whipped tallow)
INSERT INTO product_ingredients (product_sku, product_name, ingredient_id, percentage)
SELECT 'PP-NATURAL', 'Natural', id, v.pct FROM ingredients i
JOIN (VALUES
  ('Tallow', 98.62), ('Jojoba Oil', 1.38)
) AS v(ing_name, pct) ON i.name = v.ing_name;

-- Vanilla Rose (whipped tallow)
INSERT INTO product_ingredients (product_sku, product_name, ingredient_id, percentage)
SELECT 'PP-VANILLA-ROSE', 'Vanilla Rose', id, v.pct FROM ingredients i
JOIN (VALUES
  ('Tallow', 97.62), ('Jojoba Oil', 1.38), ('Vanilla', 0.5), ('Rose Essential Oil', 0.5)
) AS v(ing_name, pct) ON i.name = v.ing_name;

-- Frankincense (whipped tallow)
INSERT INTO product_ingredients (product_sku, product_name, ingredient_id, percentage)
SELECT 'PP-FRANKINCENSE', 'Frankincense', id, v.pct FROM ingredients i
JOIN (VALUES
...
INSERT INTO product_ingredients (product_sku, product_name, ingredient_id, percentage)
SELECT 'PP-LAVENDER', 'Lavender', id, v.pct FROM ingredients i
JOIN (VALUES
  ('Tallow', 97.62), ('Jojoba Oil', 1.38), ('Lavender', 1.0)
) AS v(ing_name, pct) ON i.name = v.ing_name;

-- Vanilla Manuka (whipped tallow)
INSERT INTO product_ingredients (product_sku, product_name, ingredient_id, percentage)
SELECT 'PP-VANMAN', 'Vanilla Manuka', id, v.pct FROM ingredients i
JOIN (VALUES
  ('Tallow', 97.38), ('Jojoba Oil', 1.38), ('Manuka Honey', 1.0), ('Vanilla', 0.24)
) AS v(ing_name, pct) ON i.name = v.ing_name;

-- Blue Tansy (whipped tallow)
INSERT INTO product_ingredients (product_sku, product_name, ingredient_id, percentage)
SELECT 'PP-BLUE-TANSY', 'Blue Tansy', id, v.pct FROM ingredients i
JOIN (VALUES
